...
export default function PricingCard({ type, pricePerPack, pricePerImage, l1, l2, l3, btnText, priceId, credits }) {
        ...
        <>
            <div className="pricingCard group bg-[#171616] max-w-[286px] w-full rounded-xl h-full  py-4 flex flex-col justify-between items-center text-center ">
                ...
                <div className="w-full px-4.5">
                    <p>No Subscription</p>
                    <PrimaryButton text={btnText} onClick={handleCheckout} className="mt-3 w-full group-hover:bg-white group-hover:bg-none group-hover:text-[#0D0D0D]" />
                </div>
            </div>
