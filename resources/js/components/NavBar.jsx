        ...
        <header>
            <div className="nav-inner mx-auto py-8.5 px-4 flex justify-around items-center container relative">
                ...
                {user ? (
                    ...
                    <PrimaryButton text="Sign In" className="w-1/8" onClick={() => router.visit("/signup")} />
                )}
            </div>
        </header>
    )
